 ...
 */
 ...
 <div id="primary" class="content-area">
	 <main id="main" class="site-main">
		 ...
		 <section class="f-banner">
			 <img src="<?php echo get_template_directory_uri(); ?>/images/main1.png" alt="Banner Image">
		 </section>
		 <section class="HL">
		 ...
		 <!-- Section 1 -->
		 <section class="f-banner">
			 <img src="<?php echo get_template_directory_uri(); ?>/images/main2.png" alt="Banner Image">
		 </section>
		 <section class="HL">
		 ...
		 <!-- Section 2 -->
		 <section class="f-banner">
			 <img src="<?php echo get_template_directory_uri(); ?>/images/main3.png" alt="Banner Image">
		 </section>
		 <section class="HL">
 ...
 <section class="team-members">
     <div class="container">
         ...
         <!-- Image 2 -->
         <div class="team-member">
             <img src="<?php echo get_template_directory_uri(); ?>/images/IMG_20210521_143233.png" alt="MutianGao">
             <p>MutianGao</p>
         </div>

         <!-- Image 3 -->
         <div class="team-member">
             <img src="<?php echo get_template_directory_uri(); ?>/images/Lu.jpg" alt="LuZhixian">
             <p>LuZhixian</p>
         </div>

         <!-- Image 4 -->
         <div class="team-member">
             <img src="<?php echo get_template_directory_uri(); ?>/images/logo_main.png" alt="TanjodiNickson 4">
             <p>TanjodiNickson</p>
         </div>
     </div><!-- .container -->
